...
#TESTING STATEMENTS
#Player.full_name = 'Mark Miles'
#Player.house = 'Gryffindor'

class Chapter():
    class Dialogue():
        def __init__(self):
            self.options = {'1': 'Branch'}

        def Branch_1(self, user_input):
            if user_input == '1':
                if Player.full_name.upper() in Blacklist:
                ...
                user_input = input()
                Chapter.Dialogue.Branch_1(self, user_input)
        ...
        def Branch_2(self, user_input):
            if user_input == '1':
                ...
                user_input = input()
                Chapter.Dialogue.Branch_2(self, user_input)
        ...
        def Branch_3(self, user_input):
            if user_input == '1':
                ...
                print('\nMILO: What was that?\n')
                user_input = input()
                Chapter.Dialogue.Branch_3(self, user_input)
        ...
        def Branch_4(self, user_input):
            if user_input == '1':
                ...
                print('\nMILO: What was that?\n')
                user_input = input()
                Chapter.Dialogue.Branch_4(self, user_input)
    ...
    def Execute_Main(self):
        ...
        print(' ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ', end=' ')
        input()
        print(f"\n~ You settle into the {Player.house} common room and you couldn’t feel more at home. ~", end='')
        input()
        ...
        if Player.house != 'Slytherin':
            ...
            input()
            print(
            f"\n[1] I’m {Player.first_name}. {Player.full_name}.\n"
